package com.markchan.androidsticker.sample.util;
...
public class Utils {
     ...
     * 解析xml文件
     */
    public static ArrayList<HashMap<String, String>> parseXML(InputStream inStream,
            String packageName) {
                    ...
                    case XmlPullParser.START_TAG://开始元素事件
                        ...
                        if (name.equalsIgnoreCase("material")) {
                            ...
                            if (name.equalsIgnoreCase("name")) {
                                map.put("name",
                                        packageName + "/" + parser.nextText());// 如果后面是Text元素,即返回它的值
